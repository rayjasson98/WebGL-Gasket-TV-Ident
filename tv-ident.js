...
function animate(obj, controls) {
    ...
    else { // current animation has not completed, proceeds with same animation
...
function renderObject(controls, obj) {
    points = [];
    colors = [];
    divideTetra(obj.vertices[0], obj.vertices[1], obj.vertices[2], obj.vertices[3], obj.division);
